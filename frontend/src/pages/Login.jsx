...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-950 px-6 relative overflow-hidden">
      ...
      <div className="absolute bottom-[-20%] right-[-20%] w-[500px] h-[500px] bg-emerald-600/10 blur-[120px] rounded-full"></div>
      ...
      <div className={`w-full max-w-md bg-slate-900/60 backdrop-blur-3xl p-10 rounded-[40px] border border-white/10 shadow-2xl z-10 transition-all duration-1000 ${mounted ? "opacity-100 scale-100" : "opacity-0 scale-95"}`}>
        ...
        <p className="text-center text-slate-400 mb-10 text-sm">Please enter your details</p>
        ...
        <p className="text-center mt-8 text-slate-400 text-sm">
          ...
          <span className="text-indigo-400 font-bold cursor-pointer hover:underline" onClick={() => navigate("/signup")}>
            Sign up
          </span>
        </p>
      </div>
